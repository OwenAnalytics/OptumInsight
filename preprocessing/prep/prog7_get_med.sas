...
%macro create_med(yr=);
	...
	from medical.med_dvt_&yr(keep=patid conf_id diag1-diag25 fst_dt pos proc_cd prov rename=(patid=patid2)) 
...
proc export data=final
   outfile='C:\Users\mengbing\Box Sync\OptumInsight_DataManagement\data\prog7_get_med.txt'
   dbms=tab
   replace;
   putnames=yes;
run;
