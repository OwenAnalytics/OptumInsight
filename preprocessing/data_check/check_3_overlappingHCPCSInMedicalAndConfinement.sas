/****************************************************************************
* Program: check_3_overlappingHCPCSInMedicalAndConfinement.sas			   
*
* Location: ~\Box Sync\OptumInsight_DataManagement\preprocessing\data_check 
*
* Author: Mengbing Li 
*
* Created: Friday, March 18, 2018 
*
* Description: *DO NOT RUN FOR SUBSETTING PURPOSES.*
* This program checks whether the HCPCS codes from medical data and facility data
* 
*
...
%macro read_code(outname=,sheet=);
	proc import out = &outname
	    datafile = 'C:/Users/mengbing/Box Sync/OptumInsight_DataManagement\preprocessing\others\All_codes_ICD9_NDC_HCPCS.xlsx'
	    dbms = xlsx
		replace;
	    sheet = &sheet;
	    getnames = yes;
...
proc export data=final
	outfile="C:/Users/mengbing/Box Sync/OptumInsight_DataManagement\data\check_3_overlappingHCPCSInMedicalAndConfinement.xlsx"
	dbms=xlsx replace;
	putnames=yes;
run;
