/****************************************************************************
* Program: check_2_cancer_medical_confinement_overlap.sas			   
*
...
* This one-time program is run after subsetting. It checks whether ICD-9 
* codes of cancers from medical and confinement claims data overlap, among 
* eligible patients from the result of subsetting. The final output contains
* information about eligible patients who have cancer doagnosis in only one 
* of medical and confinement data, but not both.
*
