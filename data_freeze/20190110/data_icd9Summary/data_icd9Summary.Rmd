...
knitr::opts_knit$set(root.dir = 'C:/Users/mengbing/Box Sync/OptumInsight_DataManagement/data_freeze/20190110/data_icd9Summary')
...
The data file used in this summary is ``Box Sync\OptumInsight_DataManagement\data_freeze\20190110\diagInpatient_long.csv``. For a description of the data file, go to `Box Sync\OptumInsight_DataManagement\data_freeze\20190110\DataDescription.md`.


For an overview of the data, here is the number of unique ICD-9 codes in our cohort data, regardless of which level of the code is in.
```{r}
...
length(unique(diagInpatient$icd9_raw))
```
