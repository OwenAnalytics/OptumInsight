...
#' algorithm. 
#' 
#' Method 1: The skip-gram model with negative sampling
...
#' 
#' Method 2: Glove algorithm in text2vec package
#' 
#' Author: Mengbing Li
#' 
#' Created: 02/10/2019
...
### Method 1: SVD on the SPPMI matrix ###
...
### Method 2: Use the GloVe algorithm ###
### create a vocabulary ----------------------------------------------
