...
setwd("C:/Users/mengbing/Box Sync/OptumInsight_DataManagement/data_freeze/20190110/simulation_tree_icd9")
...
# input: root name. i.e. a 3-digit code
sampleICD9Codes <- function(root){
...
source("../functions/draw_tree/draw_tree.R")
draw_tree("564")
