##################################################
#' Program name: data_icd9_structure.R
#' 
...
data_icd9[, count_3digits := ifelse(icd9_3digits=="", -1L, .N), by = icd9_3digits]
...
length(unique(data_icd9.counts$icd9_3digits)) #1190
length(unique(data_icd9.counts$icd9_4digits)) #5836
length(unique(data_icd9.counts$icd9_5digits)) #6106
