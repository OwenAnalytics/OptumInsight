...
# # separate inpatient and outpatient diagnoses
# test.diag_inpatient_long <- test.diag_long[conf_id != "", ]
# test.diag_outpatient_long <- test.diag_long[conf_id == "", ]
# 
# test.diag_outpatient <- reshape(test.diag_outpatient_long,
#                   idvar = c("patid", "conf_id", "fst_dt", "lst_dt", "copay_sum"),
#                   timevar = "diag", direction = "wide")
...
# re-order columns
diag_names <- grep("diag", colnames(test.medical_allDiag), value = TRUE)

diag1_names <- paste0("diag1_", 1:length(grep("diag1_", diag_names)))
diagX_names <- diag_names[! (diag_names %in% diag1_names)]
