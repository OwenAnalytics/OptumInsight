#######################################################################################
####                                                                               ####
#### 1. EXCLUDE PATIENTS WHO DO NOT GET AN OUTPATIENT AC WITHIN 30 DAYS AFTER      ####
####    INDEX VTE                                                                  ####
...
patinfo <- read_excel("../data/subset_ac_active_withclm.xlsx", sheet = "subset_ac_active_withclm")
